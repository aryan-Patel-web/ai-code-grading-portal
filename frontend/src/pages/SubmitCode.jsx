...
/**
 * SubmitCode page — student submits Python code, sees per-test-case results.
 * Calls POST /api/submissions → sandboxed execution → graded results stored in MongoDB.
 */
export default function SubmitCode() {
  ...
  return (
    <div style={styles.page}>
      ...
      {/* Problem Statement — hardcoded MVP problem */}
      ...
      {results && (
        <div style={styles.resultsSection}>
          <div style={styles.scoreBanner(allPass)}>
            <span style={{ fontSize: 28 }}>{allPass ? '🎉' : '⚠️'}</span>
            <div>
